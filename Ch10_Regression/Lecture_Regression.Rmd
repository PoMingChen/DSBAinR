...
Beta
Beta$Value <- Beta$Value %>% as.character() %>% as.numeric() ##這是標準用來轉換成數值變數的過程。
...
> 這邊一樣是區域A B分開討論，看其估計係數，延續最終refine Model
...
#the percentage error is about 9.7% in Store1
